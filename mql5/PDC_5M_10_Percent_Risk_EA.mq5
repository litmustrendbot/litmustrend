...
#property description "PDC 5M BOS FVG (10% Risk) Expert Advisor for MetaTrader 5"
...
input ulong    InpMagicNumber       = 55510;          // Unique EA Magic Number
input ulong    InpSlippage          = 10;             // Allowed Slippage (Points)

//--- DEFINITIONS & PREFIXES
#define OBJ_PREFIX "PDC10_"
